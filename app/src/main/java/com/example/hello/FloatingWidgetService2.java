...
public class FloatingWidgetService2 extends Service implements View.OnClickListener {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        //롱클릭 리스너
                        handler_longClick.postDelayed(runnable_longClick, 1200);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.floating_widget_image_view:
                ...
                Intent intent = new Intent(FloatingWidgetService2.this,MainActivity.class);
